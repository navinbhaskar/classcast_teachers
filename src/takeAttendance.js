...
constructor(props) {
  ...
  render() {
    return (
      ...
      <View style={{ width: '100%', height: 10 * vh, flexDirection: 'row', alignItems: 'center'}}>
      <Image
          ...
          style={{height: 10 * vw, width: 10 * vw, marginLeft: 5 * vw}}
          />
        <Text style={{fontFamily: 'Montserrat-Bold', fontSize: 4 * vw, color: 'black', paddingLeft: 5 * vw, paddingTop: 2 * vh, paddingBottom: 2 * vh}}>{'Date: '+ this.state.today.getDate() + "/"+ parseInt(this.state.today.getMonth()+1) +"/"+ this.state.today.getFullYear()+"  "}</Text>
      </View>
